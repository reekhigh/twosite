        ...
        <div class="row">
            ...
            <div class="breadcrumbs">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Управление позициями</li>
                </ol>
            </div>

            <a href="/admin/product/create" class="btn btn-default back"><i class="fa fa-plus"></i> Добавить позицию</a>
            ...
            <table class="table-bordered table-striped table">
                <tr>
                    <th>ID товара</th>
                    <th>Описание для себя</th>
                    <th>Название позации</th>
                    <th>Цена</th>
                    <th></th>
                    <th></th>
                </tr>
